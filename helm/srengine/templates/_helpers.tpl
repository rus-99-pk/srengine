...
{{/*
Ollama service name — used in agent's env as OLLAMA_URL.
*/}}
...
{{/*
Helper to generate agent environment variables.
Centralized here to avoid duplication across Deployments/Jobs.
*/}}
